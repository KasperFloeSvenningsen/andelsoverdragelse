      ...
      <div>
        ...
        <label className="flex items-start gap-3 cursor-pointer">
          ...
          <div>
            ...
            <div className="text-xs text-gray-500">Overdragelsesaftale klar på 2 hverdage i stedet for 10-20 hverdage (se prislisten på blomfelt.dk)</div>
          </div>
        </label>
      </div>
...
function Trin4({ data, setData }: { data: WizardData; setData: (d: WizardData) => void }) {
  // Minimum overtagelsesdato = 6 uger fra nu
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="card text-center max-w-lg">
          ...
          <p className="text-gray-600 mb-6">
            Tak, {sagInfo.saelger_navn}. Systemet bestiller nu rapporter hos Cera.
          </p>
          ...
          <a href="/admin" className="btn-secondary mt-6 inline-block text-sm">
            Se admin-dashboard
          </a>
        </div>
      </main>
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#FDF6E1' }}>
      ...
      <main className="flex-1 p-6">
        <div className="max-w-2xl mx-auto">
          {/* Kontekst-banner */}
          <div className="rounded-lg px-4 py-3 mb-6 text-sm border" style={{ backgroundColor: '#2C403A' + '14', borderColor: '#2C403A' + '30' }}>
